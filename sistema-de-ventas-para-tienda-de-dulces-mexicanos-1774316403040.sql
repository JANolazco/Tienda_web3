...
--
-- Name: cash_register_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.cash_register ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.cash_register_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
INSERT INTO meta.migrations VALUES ('202407160001', 'embeddings', '2026-03-24 00:56:01.924+00');
...
--
-- Name: cash_register_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.cash_register_id_seq', 1, false);
